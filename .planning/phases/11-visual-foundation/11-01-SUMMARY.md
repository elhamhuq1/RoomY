...
plan: 01
subsystem: ui
tags: [nativewind, tailwind, design-tokens, color-palette, avatar, card]

# Dependency graph
requires:
  - phase: 06-design-system
    provides: "Design token structure in colors.ts and tailwind.config.js"
provides:
...
affects: [11-02, 11-03, 12-empty-states, 13-profile-pictures]

# Tech tracking
tech-stack:
  added: []
  patterns: ["Transparent card with outline border on cream background", "Earth-tone gradient pairs for avatar identity"]
...
requirements-completed: [VIS-01, VIS-02, VIS-04, VIS-05, CARD-01]
