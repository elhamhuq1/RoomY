...
- [x] **Phase 7: Home Screen** - Calendar, balance summary, attention feed, weekly timeline (UAT gap closure in progress)
- [x] **Phase 8: Expenses Screen** - Balance cards, differentiated history rows, date group headers (UAT gap closure in progress)
- [x] **Phase 9: Groceries + Chores** - Section headers, checkboxes, avatars, emoji icons, stats, dispute styling
...
- [x] 07-04-PLAN.md — Gap closure: fix empty timeline, hide settled balance buttons, preserve refresh date
...
- [x] 08-03-PLAN.md — Gap closure: chevron expand affordance and "Expenses by Roommate" all-members section
...
Plans:
- [x] 09-01-PLAN.md — Grocery presentational components and parent screen rewrite with circle checkboxes, avatars, collapsible DONE section
- [x] 09-02-PLAN.md — Chore presentational components and parent screen rewrite with stats cards, emoji icons, dispute styling
...
Plans:
- [x] 10-01-PLAN.md — Infrastructure setup (images, expo-blur, StepProgressBar) and welcome carousel restyle
- [x] 10-02-PLAN.md — Auth screens restyle (sign-up, sign-in, forgot-password) with "Sign In" to "Log In" rename
- [x] 10-03-PLAN.md — Profile, household choice, and create-household name form with illustrations and progress bar
- [x] 10-04-PLAN.md — Invite code celebration, join-household, member-welcome, and module-quiz restyle
