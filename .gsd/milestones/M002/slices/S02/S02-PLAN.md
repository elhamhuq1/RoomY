...
- [ ] **T01: Build import-recipe Edge Function** `est:1h`
...
- [ ] **T02: Build recipe import screen with ingredient review and bulk insert** `est:1.5h`
...
- [ ] **T03: Wire import-recipe route and refactor groceries action buttons** `est:30m`
