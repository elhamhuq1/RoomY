...
- [ ] **T01: Deploy Kroger Edge Functions and store settings migration** `est:1.5h`
...
- [ ] **T02: Build product search screen with store selection and grocery list integration** `est:1.5h`
